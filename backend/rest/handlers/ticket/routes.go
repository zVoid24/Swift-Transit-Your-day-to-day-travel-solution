...
func (h *Handler) RegisterRoutes(mux *http.ServeMux) {
	...
	mux.Handle("POST /ticket/payment/fail", h.mngr.With(http.HandlerFunc(h.PaymentFail)))
	mux.Handle("POST /ticket/payment/cancel", h.mngr.With(http.HandlerFunc(h.PaymentCancel)))
